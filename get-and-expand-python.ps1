...
& "downloaded/python-${pythonver}-amd64-full.exe" /quiet /log  expanded/install-log.txt AssociateFiles=0 Include_doc=0 Include_dev=0 Include_launcher=0 Include_pip=0 Include_test=0 Shortcuts=0 DefaultJustForMeTargetDir=expanded | Out-Default
